...
<body>
    ...
    <!-- JavaScript para controlar el modal y enviar el valor mediante Fetch -->
    <script>
    ...
    <script>
        ...
        async function removeRecord(tableName, id) {
            try {
                ...
                const response = await fetch(`tabla.php?name=${tableName}&inputValue=${inputValue}`, options);
        ...
        function showTable(tableName, filters) {
            ...
            fetch(`tabla.php?name=${tableName}&inputValue=${inputValue}&${filters}`)

...
Smart_Manager.prototype.loadNavBar = function() {
	...
	let sm_top_bar = ' <style> .noselect { -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; } </style>' +'<div id="sm_top_bar" style="font-weight:400 !important;width:100%;">'+
						'<div id="sm_top_bar_left" class=" noselect sm_beta_left" style="width:'+ window.smart_manager.grid_width +'px;background-color: white;padding: 0.5em 0em 1em 0em;">'+
							'<div class="sm_top_bar_action_btns">'+
								'<div id="batch_check_all_products" title="Check All" class="sm_beta_dropdown">'+
...
Smart_Manager.prototype.isTasksEnabled = function(){
...
/*Review*/
	...
	.off('click', "#batch_check_all_products").on('click', "#batch_check_all_products", function(){
		window.smart_manager.selectAll = true;
		let _temp = []
		window.smart_manager.currentDashboardData.forEach(function(row){			
			_temp.push({
				'posts_id': row['posts_id'],
			});			
		});
		window.smart_manager.selectedRows = _temp;
	})
...
(function(Handsontable){
	...
	Smart_Manager.prototype.addTasksParams = function(params = {}){
	...
	Smart_Manager.prototype.getColDisplayName = function(colSrc = ''){
	...
	// For updating image
	Smart_Manager.prototype.inlineUpdateImage = function(imageParams){
	...
	Smart_Manager.prototype.changeDashboardDisplayName = function(dashboardDisplayName = ''){
	...
	Smart_Manager.prototype.displayGalleryImagesModal = function(galleryImageParams){
	...
	Smart_Manager.prototype.displayTitleModal = function(params){
	...
	Smart_Manager.prototype.displayTasks = function (params = {}){
